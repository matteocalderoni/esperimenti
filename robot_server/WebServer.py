...
def show_network_mode():
    try:
        ...
        pass
async def broadcast_to_ws(message):
...
def run_tcp_server():
    ...
    try:
        ...
        tcpSerSock.listen(5)
        print(f"[TCP SERVER] Listening on port {PORT} for Desktop Client...")
    except Exception as e:
        print(f"[TCP SERVER ERROR] Cannot bind to port {PORT}: {e}")
        return
...
if __name__ == '__main__':
    ...
    # Start the TCP Socket Server for the Desktop Client
