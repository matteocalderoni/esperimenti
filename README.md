...
* **Arena Top-Down 2D**: Campo di prova con tracciato a linea nera, ostacoli, pallina verde per OpenCV e cono ultrasuoni.
* **Telecamera FPV 3D**: Visuale prospettica basata sull'inquadratura reale della testa Pan-Tilt.
* **Fisica & Modalità Autonome**: Simulazione ostacoli (`automatic`), inseguimento colore (`findColor`), seguipista IR (`trackLine`) e luci polizia (`police`).
