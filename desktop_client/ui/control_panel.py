...
class ControlPanel:
    def __init__(self, parent, motor_x, motor_y, servo_x, servo_y, send_callback):
        ...
        self.traction_card = tk.LabelFrame(parent, text=" Trazione & Sterzata ", bg='#121212', fg='#29B6F6', bd=1, relief='solid', font=('Helvetica', 10, 'bold'))
        self.traction_card.place(x=motor_x, y=motor_y, width=320, height=210)
        
        self.servo_card = tk.LabelFrame(parent, text=" Pan-Tilt & Servomotori ", bg='#121212', fg='#29B6F6', bd=1, relief='solid', font=('Helvetica', 10, 'bold'))
    ...
    def build_servo_buttons(self, x, y):
        ...
        btn_left = tk.Button(self.servo_card, width=8, text='Sinistra', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
        ...
        btn_up = tk.Button(self.servo_card, width=8, text='Su', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
        ...
        btn_down = tk.Button(self.servo_card, width=8, text='Giu', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
        ...
        btn_right = tk.Button(self.servo_card, width=8, text='Destra', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
    ...
    def build_motor_buttons(self, x, y):
        ...
        btn_left = tk.Button(self.traction_card, width=8, text='Sinistra', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
        ...
        btn_forward = tk.Button(self.traction_card, width=8, text='Avanti', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
        ...
        btn_backward = tk.Button(self.traction_card, width=8, text='Indietro', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
        ...
        btn_right = tk.Button(self.traction_card, width=8, text='Destra', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
        ...
        btn_spin_l = tk.Button(self.traction_card, width=8, text='Ruota SX', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
        ...
        btn_spin_r = tk.Button(self.traction_card, width=8, text='Ruota DX', fg=settings.color_btn_text, bg=settings.color_btn, relief='ridge')
        ...
        lbl_speed = tk.Label(self.traction_card, text='Velocità:', fg=settings.color_text, bg='#121212')
